...
class floatingPopulationList extends Component {
    ...
    callFloatPopulListApi = async () => {
            axios.get('https://api.bigdatahub.co.kr/v1/datahub/datasets/search.json?pid=1002332&TDCAccessKey=3dfa6c8f64ac8a289ea752b54a5965b6c6c474271e2a7c69cc5c7686521f2bd5&$count=30', {
            })
            .then( response => {
                try {
